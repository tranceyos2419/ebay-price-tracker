      ...
      <DialogContent className="max-w-md mx-auto rounded-lg shadow-xl border border-gray-200 bg-white p-6">
        ...
        <DialogFooter className="mt-6 flex justify-center gap-4">
          <Button
            ...
            onClick={onClose}
            disabled={isLoading}
            className="w-24 py-2 text-gray-700 border-gray-300 rounded-md hover:bg-gray-100 transition-colors duration-200 shadow-sm cursor-pointer disabled:opacity-50"
          >
            Cancel
          </Button>
          <Button
            ...
            disabled={isLoading}
            className="w-24 py-2 bg-red-600 hover:bg-red-700 text-white rounded-md transition-colors duration-200 shadow-sm cursor-pointer disabled:opacity-50"
          >
